...
import com.banco.apiusuarios.dto.UsuarioCreationDto.TelefonoDto;
...
public class UsuarioControladorIntegrationTest {
    ...
    public void configurar() {
        ...
        // Agregar los detalles del teléfono
        UsuarioCreationDto.TelefonoDto telefonoDto = new UsuarioCreationDto.TelefonoDto();
    ...
    public void pruebaCrearUsuario() throws Exception {
        ...
        assertNotNull(respuestaDto.getCreated(), "Fecha de creación no debe ser nula");
        assertNotNull(respuestaDto.getLastLogin(), "Última fecha de inicio de sesión no debe ser nula");
